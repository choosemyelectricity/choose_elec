...
def hourly_form(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            hourly_consumption = []
            hourly_consumption.append(data['twelveAM'])
            hourly_consumption.append(data['oneAM'])
            hourly_consumption.append(data['twoAM'])
            hourly_consumption.append(data['threeAM'])
            hourly_consumption.append(data['fourAM'])
            hourly_consumption.append(data['fiveAM'])
            hourly_consumption.append(data['sixAM'])
            hourly_consumption.append(data['sevenAM'])
            hourly_consumption.append(data['eightAM'])
            hourly_consumption.append(data['nineAM'])
            hourly_consumption.append(data['tenAM'])
            hourly_consumption.append(data['elevenAM'])
            hourly_consumption.append(data['twelvePM'])
            hourly_consumption.append(data['onePM'])
            hourly_consumption.append(data['twoPM'])
            hourly_consumption.append(data['threePM'])
            hourly_consumption.append(data['fourPM'])
            hourly_consumption.append(data['fivePM'])
            hourly_consumption.append(data['sixPM'])
            hourly_consumption.append(data['sevenPM'])
            hourly_consumption.append(data['eightPM'])
            hourly_consumption.append(data['ninePM'])
            hourly_consumption.append(data['tenPM'])
            hourly_consumption.append(data['elevenPM'])
